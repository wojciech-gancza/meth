...
#include <string>
#include <iostream>
#include "../../test-of-generated-code/serialization_binary_serialization.h"
...
namespace Bmqpub
{
  class PublishingRule
  {
    public:
      ...
      friend Serialization::BinarySerializer& operator<<(Serialization::BinarySerializer& output, const PublishingRule& publishing_rule)
      {
        output.storeValue(publishing_rule.m_publishing_rule);
        return output;
      }
      
      friend Serialization::BinaryDeserializer& operator>>(Serialization::BinaryDeserializer& input, PublishingRule& publishing_rule)
      {
        input.readValue(publishing_rule.m_publishing_rule);
        return input;
      }
