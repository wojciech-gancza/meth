...
namespace Test
{
    ...
    , public Common::Network::PortNumber
  {
    public:
      ...
      JustARecord& operator=(const JustARecord& just_a_record) noexcept = default;
      JustARecord& operator=(JustARecord&& just_a_record) noexcept = default;
      ...
      friend Serialization::BinarySerializer& operator<<(Serialization::BinarySerializer& output, const JustARecord& just_a_record);
      friend Serialization::BinaryDeserializer& operator>>(Serialization::BinaryDeserializer& input, JustARecord& just_a_record);
