...
namespace Common
{
  class TextMessage
  {
    public:
      ...
      constexpr TextMessage() noexcept
        : m_text_message("No comments.")
      {  }
  
      explicit TextMessage( const std::string& text_message )
      ...
      void setTextMessage(std::string text_message) noexcept { m_text_message = text_message; checkSize(); }
      void setTextMessage(const TextMessage& text_message) noexcept{ *this = text_message; }
      void setFrom(const TextMessage& text_message) noexcept { *this = text_message; }
      void setFrom(TextMessage&& text_message) noexcept { *this = text_message; }
      ...
      friend std::ostream& operator<<(std::ostream& output, const TextMessage& text_message);
      
      friend Serialization::BinarySerializer& operator<<(Serialization::BinarySerializer& serializer, const TextMessage& text_message);
      friend Serialization::BinaryDeserializer& operator>>(Serialization::BinaryDeserializer& deserializer, TextMessage& text_message);
