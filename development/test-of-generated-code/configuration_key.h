...
namespace Configuration
{
  class Key
  {
    public:
      ...
      bool operator==(const Key& other) const noexcept { return Common::RegexCompare::isEqual(this->m_key, other.m_key); }
      bool operator!=(const Key& other) const noexcept { return Common::RegexCompare::isNotEqual(this->m_key, other.m_key); }
      bool operator<(const Key& other) const noexcept { return Common::RegexCompare::isLower(this->m_key, other.m_key); }
      bool operator<=(const Key& other) const noexcept { return Common::RegexCompare::isLowerOrEqual(this->m_key, other.m_key); }
      bool operator>=(const Key& other) const noexcept { return Common::RegexCompare::isAboveOrEqual(this->m_key, other.m_key); }
      bool operator>(const Key& other) const noexcept { return Common::RegexCompare::isAbove(this->m_key, other.m_key); }
