...
// based on pattern file:       .../patterns/integer.h.pattern
  ...
  namespace Network
  {
    class PortNumber
    {
      public:
        ...
        constexpr PortNumber( uint16_t port_number = 0 ) noexcept
        ...
        void setPortNumber(const PortNumber& port_number) { *this = port_number; }
        void setFrom(const PortNumber& port_number) { *this = port_number; }
        void setFrom(PortNumber&& port_number) { *this = port_number; }
