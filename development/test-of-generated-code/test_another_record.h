...
namespace Test
{
    ...
    , public Common::Network::PortNumber
  {
    public:
      ...
      friend Serialization::BinarySerializer& operator<<(Serialization::BinarySerializer& serializer, const AnotherRecord& another_record);
      friend Serialization::BinaryDeserializer& operator>>(Serialization::BinaryDeserializer& deserializer, AnotherRecord& another_record);
