...
class PlainOldDataTypes:
    ...
    def __init__(self, soluton_path, output_path):
        ...
        self.generator = meth.Metamorph(self.environment.patterns_path.get_as_directory(), output_path.get_as_directory())
    ...
    def generate_integer(self, properties):
        ...
        self.generator.generate("source.file.pattern", extended_properties["header_file_name"], extended_properties)
